pipeline {
    ...
    post {
        ...
        failure {
            emailext body: 'A Test EMail', recipientProviders: [[$class: 'DevelopersRecipientProvider'], [$class: 'RequesterRecipientProvider']], charset: 'UTF-8', from: 'address not configured yet  <nobody@nowhere>', mimeType: 'text/plain', replyTo: 'jenkins@gmail.com', subject: "Build fail in jenkins: ${env.JOB_NAME} #${env.BUILD_NUMBER}", to: "mailtrap@gmail.com";
